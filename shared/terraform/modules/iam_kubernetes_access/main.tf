...
module "iam_policy_aws_ingress_controller_access" {
  source  = "terraform-aws-modules/iam/aws//modules/iam-policy"
  version = "4.14.0"

  name        = "DeveloperAwsIngressControllerAccess"
  path        = "/"
  description = ""
...
module "iam_policy_cloudfront_access" {
  ...
  name        = "DeveloperCloudFrontAccess"
  path        = "/"
...
module "iam_user_developer_access" {
  source  = "terraform-aws-modules/iam/aws//modules/iam-user"
  version = "4.14.0"

  name = "KubernetesDeveloperAccess"
}

resource "aws_iam_user_policy_attachment" "attach_s3_access_policy" {
  user       = module.iam_user_developer_access.iam_user_name
